...
import (
	...
	"github.com/peak-scale/observability-tenancy/internal/handlers/processors/cortex"
...
func main() {
	...
	proc := cortex.NewCortexProcessor(ctrl.Log.WithName("processor"), *cfg, store, metricsRecorder)
